...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "sqldelight-pgsearch"
            groupId = project.group.toString()
            version = project.version.toString()

            pom {
                name.set("SQLDelight pg_search Module")
                description.set("SQLDelight module for pg_search support")
                url.set("https://github.com/griffio/sqldelight-pgsearch-module-app")
                ...
                scm {
                    connection.set("scm:git:git://github.com/griffio/sqldelight-pgsearch-module-app.git")
                    developerConnection.set("scm:git:ssh://github.com/griffio/sqldelight-pgsearch-module-app.git")
                    url.set("https://github.com/griffio/sqldelight-pgsearch-module-app")
                }
            }
        }
...
jreleaser {
    gitRootSearch = true
    project {
        description = "SQLDelight module for pg_search support"
